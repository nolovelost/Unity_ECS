...
public class JobManager : MonoBehaviour
{
    ...
    JobCarTransform carJobTransform;
    ...
    void Update()
    {
        ...
        carJobTransform = new JobCarTransform()
        {
        ...
        carJobHandle = carJobTransform.Schedule(transforms);
    ...
    void AddCars()
    {
        ...
        for (int i = 0; i < carIncremementAmount; i++)
        {
            ...
            GameObject obj = Instantiate(carPrefab, pos, rot) as GameObject;
